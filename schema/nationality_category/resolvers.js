...
const getNationalityCategories = async () => {
  try {
    let sql = `SELECT * FROM nationality_categories`;
    ...
    throw new GraphQLError(
      "Error fetching nationality categories " + error.message
    );
  }
};

const nationalityCategoryResolvers = {
  Query: {
    nationality_categories: async () => {
      const result = await getNationalityCategories();
      return result;
    },
  },
  // Level: {
...
export default nationalityCategoryResolvers;
